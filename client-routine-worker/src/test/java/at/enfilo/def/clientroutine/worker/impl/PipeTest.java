...
public class PipeTest {
	...
	public void setUp() throws Exception {
		...
		pipe = new Pipe(ClientRoutineWorker.getInstance().getConfiguration().getWorkingDir(), name);
	}
	...
	public void pipePath() throws Exception {
		Path expected = Paths.get(ClientRoutineWorker.getInstance().getConfiguration().getWorkingDir(), pipe.getName()).toAbsolutePath();
