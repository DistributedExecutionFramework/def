...
[Serializable]
#endif
public partial class DEFBooleanVector : TBase
{
  private string __id;
  ...
  public DEFBooleanVector() {
    this.__id = "29198299-1d34-3cd7-b7bc-e2ac1def2c80";
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("DEFBooleanVector");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("DEFBooleanVector(");
    bool __first = true;
    if (_id != null && __isset._id) {
