...
[Serializable]
#endif
public partial class DEFDoubleVector : TBase
{
  private string __id;
  ...
  public DEFDoubleVector() {
    this.__id = "d76dfe60-9cdb-3264-833c-b2083977e13a";
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("DEFDoubleVector");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("DEFDoubleVector(");
    bool __first = true;
    if (_id != null && __isset._id) {
