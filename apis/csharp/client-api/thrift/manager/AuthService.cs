...
public partial class AuthService {
  ...
  public interface Iface : ISync {
    ...
    /// <param name="password"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_getToken(AsyncCallback callback, object state, string name, string password);
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_getToken(AsyncCallback callback, object state, string name, string password)
    {
      return send_getToken(callback, state, name, password);
    }
    ...
    public string getToken(string name, string password)
    {
      ...
      #else
      var asyncResult = Begin_getToken(null, null, name, password);
      return End_getToken(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_getToken(AsyncCallback callback, object state, string name, string password)
    #else
    public void send_getToken(string name, string password)
    #endif
    {
  ...
  public class Processor : TProcessor {
    ...
    public void getToken_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.getToken(args.Name, args.Password);
