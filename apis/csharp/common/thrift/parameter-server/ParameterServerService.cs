...
public partial class ParameterServerService {
  /// <summary>
  ...
  public interface ISync {
    ...
    string setParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol);
    /// <summary>
    ...
    string createParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type);
    /// <summary>
    ...
    /// <param name="parameterId"></param>
    /// <param name="protocol"></param>
    string getParameter(string programId, string parameterId, ParameterProtocol protocol);
    /// <summary>
    ...
    /// <param name="parameter"></param>
    /// <param name="protocol"></param>
    string addToParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol);
    /// <summary>
    ...
    /// <param name="programId"></param>
    /// <param name="parameterId"></param>
    string deleteParameter(string programId, string parameterId);
    /// <summary>
    /// Delete all stored parameters for the given programId
    /// 
    /// </summary>
    /// <param name="programId"></param>
    string deleteAllParameters(string programId);
  }
  ...
  public interface Iface : ISync {
    ...
    /// <param name="protocol"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_setParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol);
    ...
    /// <param name="type"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_createParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type);
    ...
    /// <param name="protocol"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_getParameter(AsyncCallback callback, object state, string programId, string parameterId, ParameterProtocol protocol);
    string End_getParameter(IAsyncResult asyncResult);
    #endif
    /// <summary>
    /// Update a stored parameter with the given program id and parameter id by adding the value in the given parameter.
    /// </summary>
    ...
    /// <param name="protocol"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_addToParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol);
    ...
    /// <param name="parameterId"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_deleteParameter(AsyncCallback callback, object state, string programId, string parameterId);
    ...
    /// <param name="programId"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_deleteAllParameters(AsyncCallback callback, object state, string programId);
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_setParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    {
      return send_setParameter(callback, state, programId, parameterId, parameter, protocol);
    }
    ...
    public string setParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    {
      ...
      #else
      var asyncResult = Begin_setParameter(null, null, programId, parameterId, parameter, protocol);
      return End_setParameter(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_setParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    #else
    public void send_setParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    #endif
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_createParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type)
    {
      return send_createParameter(callback, state, programId, parameterId, parameter, protocol, type);
    }
    ...
    public string createParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type)
    {
      ...
      #else
      var asyncResult = Begin_createParameter(null, null, programId, parameterId, parameter, protocol, type);
      return End_createParameter(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_createParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type)
    #else
    public void send_createParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol, ParameterType type)
    #endif
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_getParameter(AsyncCallback callback, object state, string programId, string parameterId, ParameterProtocol protocol)
    {
      return send_getParameter(callback, state, programId, parameterId, protocol);
    }

    public string End_getParameter(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public string getParameter(string programId, string parameterId, ParameterProtocol protocol)
    {
      ...
      #else
      var asyncResult = Begin_getParameter(null, null, programId, parameterId, protocol);
      return End_getParameter(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_getParameter(AsyncCallback callback, object state, string programId, string parameterId, ParameterProtocol protocol)
    #else
    public void send_getParameter(string programId, string parameterId, ParameterProtocol protocol)
    #endif
    {
    ...
    public string recv_getParameter()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_addToParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    {
      return send_addToParameter(callback, state, programId, parameterId, parameter, protocol);
    }
    ...
    public string addToParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    {
      ...
      #else
      var asyncResult = Begin_addToParameter(null, null, programId, parameterId, parameter, protocol);
      return End_addToParameter(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_addToParameter(AsyncCallback callback, object state, string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    #else
    public void send_addToParameter(string programId, string parameterId, ResourceDTO parameter, ParameterProtocol protocol)
    #endif
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_deleteParameter(AsyncCallback callback, object state, string programId, string parameterId)
    {
      return send_deleteParameter(callback, state, programId, parameterId);
    }
    ...
    public string deleteParameter(string programId, string parameterId)
    {
      ...
      #else
      var asyncResult = Begin_deleteParameter(null, null, programId, parameterId);
      return End_deleteParameter(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_deleteParameter(AsyncCallback callback, object state, string programId, string parameterId)
    #else
    public void send_deleteParameter(string programId, string parameterId)
    #endif
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_deleteAllParameters(AsyncCallback callback, object state, string programId)
    {
      return send_deleteAllParameters(callback, state, programId);
    }
    ...
    public string deleteAllParameters(string programId)
    {
      ...
      #else
      var asyncResult = Begin_deleteAllParameters(null, null, programId);
      return End_deleteAllParameters(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_deleteAllParameters(AsyncCallback callback, object state, string programId)
    #else
    public void send_deleteAllParameters(string programId)
    #endif
    {
  ...
  public class Processor : TProcessor {
    ...
    public void setParameter_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.setParameter(args.ProgramId, args.ParameterId, args.Parameter, args.Protocol);
    ...
    public void createParameter_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.createParameter(args.ProgramId, args.ParameterId, args.Parameter, args.Protocol, args.Type);
    ...
    public void getParameter_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.getParameter(args.ProgramId, args.ParameterId, args.Protocol);
    ...
    public void addToParameter_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.addToParameter(args.ProgramId, args.ParameterId, args.Parameter, args.Protocol);
    ...
    public void deleteParameter_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.deleteParameter(args.ProgramId, args.ParameterId);
    ...
    public void deleteAllParameters_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.deleteAllParameters(args.ProgramId);
  ...
  public partial class setParameter_args : TBase
  {
    ...
    private ResourceDTO _parameter;
    private ParameterProtocol _protocol;
    ...
    public string ParameterId
    {
      ...
      set
      {
        __isset.parameterId = true;
        this._parameterId = value;
      }
    }

    public ResourceDTO Parameter
    {
      get
      {
        return _parameter;
    ...
    /// <summary>
    /// 
    /// <seealso cref=".ParameterProtocol"/>
    /// </summary>
    public ParameterProtocol Protocol
    {
      get
      {
        return _protocol;
          ...
          switch (field.ID)
          {
            ...
            case 4:
              if (field.Type == TType.I32) {
                Protocol = (ParameterProtocol)iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (ParameterId != null && __isset.parameterId) {
          field.Name = "parameterId";
          field.Type = TType.String;
          field.ID = 2;
          oprot.WriteFieldBegin(field);
          oprot.WriteString(ParameterId);
          oprot.WriteFieldEnd();
        }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 5:
              if (field.Type == TType.I32) {
                Type = (ParameterType)iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
