...
public partial class ClusterInfoDTO : TBase
{
  ...
  private int _numberOfClientRoutineWorkers;
  ...
  public int NumberOfClientRoutineWorkers
  {
    get
    {
      return _numberOfClientRoutineWorkers;
    }
    set
    {
      __isset.numberOfClientRoutineWorkers = true;
      this._numberOfClientRoutineWorkers = value;
    }
  }
  ...
  public struct Isset {
    ...
    public bool numberOfClientRoutineWorkers;
    ...
    try
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 9:
            if (field.Type == TType.I32) {
              NumberOfClientRoutineWorkers = iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
    ...
    try
    {
      ...
      if (ActivePrograms != null && __isset.activePrograms) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter84 in ActivePrograms)
          {
      ...
      if (__isset.numberOfClientRoutineWorkers) {
        field.Name = "numberOfClientRoutineWorkers";
        field.Type = TType.I32;
        field.ID = 9;
        oprot.WriteFieldBegin(field);
        oprot.WriteI32(NumberOfClientRoutineWorkers);
        oprot.WriteFieldEnd();
      }
  ...
  public override string ToString() {
    ...
    if (__isset.numberOfClientRoutineWorkers) {
      if(!__first) { __sb.Append(", "); }
      __first = false;
      __sb.Append("NumberOfClientRoutineWorkers: ");
      __sb.Append(NumberOfClientRoutineWorkers);
    }
    if (DefaultMapRoutineId != null && __isset.defaultMapRoutineId) {
      if(!__first) { __sb.Append(", "); }
