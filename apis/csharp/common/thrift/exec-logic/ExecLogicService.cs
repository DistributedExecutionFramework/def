...
public partial class ExecLogicService {
  ...
  public interface ISync {
    ...
    string startClientRoutine(string pId, string crId);
    /// <summary>
  ...
  public interface Iface : ISync {
    ...
    /// <param name="crId"></param>
    #if SILVERLIGHT
    IAsyncResult Begin_startClientRoutine(AsyncCallback callback, object state, string pId, string crId);
    string End_startClientRoutine(IAsyncResult asyncResult);
    #endif
    /// <summary>
    /// Request the list of Jobs (jId) for a given Program (pId).
    /// Returns a ticket id, state of ticket is available over TicketService interface, real result over Response interface.
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_startClientRoutine(AsyncCallback callback, object state, string pId, string crId)
    {
      return send_startClientRoutine(callback, state, pId, crId);
    }

    public string End_startClientRoutine(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_startClientRoutine();
    }
    ...
    {
      #if !SILVERLIGHT
      send_startClientRoutine(pId, crId);
      return recv_startClientRoutine();

      #else
      var asyncResult = Begin_startClientRoutine(null, null, pId, crId);
      return End_startClientRoutine(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_startClientRoutine(AsyncCallback callback, object state, string pId, string crId)
    #else
    public void send_startClientRoutine(string pId, string crId)
    #endif
    {
      oprot_.WriteMessageBegin(new TMessage("startClientRoutine", TMessageType.Call, seqid_));
      startClientRoutine_args args = new startClientRoutine_args();
      args.PId = pId;
      args.CrId = crId;
      args.Write(oprot_);
      oprot_.WriteMessageEnd();
    ...
    public string recv_startClientRoutine()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
      ...
      startClientRoutine_result result = new startClientRoutine_result();
      result.Read(iprot_);
      iprot_.ReadMessageEnd();
      if (result.__isset.success) {
        return result.Success;
      }
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "startClientRoutine failed: unknown result");
    }
  ...
  public class Processor : TProcessor {
    public Processor(ISync iface)
    {
      ...
      processMap_["startClientRoutine"] = startClientRoutine_Process;
    ...
    public void startClientRoutine_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      startClientRoutine_args args = new startClientRoutine_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      ...
      try
      {
        result.Success = iface_.startClientRoutine(args.PId, args.CrId);
        oprot.WriteMessageBegin(new TMessage("startClientRoutine", TMessageType.Reply, seqid)); 
        result.Write(oprot);
      }
      catch (TTransportException)
      {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("startClientRoutine", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
  ...
  [Serializable]
  #endif
  public partial class startClientRoutine_args : TBase
  {
    private string _pId;
    ...
    public startClientRoutine_args() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("startClientRoutine_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (PId != null && __isset.pId) {
          field.Name = "pId";
        ...
        if (CrId != null && __isset.crId) {
          field.Name = "crId";
          field.Type = TType.String;
          field.ID = 2;
          oprot.WriteFieldBegin(field);
          oprot.WriteString(CrId);
          oprot.WriteFieldEnd();
        }
        oprot.WriteFieldStop();
        oprot.WriteStructEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("startClientRoutine_args(");
      bool __first = true;
      if (PId != null && __isset.pId) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
  ...
  [Serializable]
  #endif
  public partial class startClientRoutine_result : TBase
  {
    private string _success;
    ...
    public startClientRoutine_result() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("startClientRoutine_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("startClientRoutine_result(");
      bool __first = true;
      if (Success != null && __isset.success) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
