...
[Serializable]
#endif
public partial class DEFLongVector : TBase
{
  private string __id;
  ...
  public DEFLongVector() {
    this.__id = "a5a968ba-4791-3aa8-b705-98d65d3d23b9";
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("DEFLongVector");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("DEFLongVector(");
    bool __first = true;
    if (_id != null && __isset._id) {
