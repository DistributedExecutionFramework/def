...
public class CSVFile implements org.apache.thrift.TBase<CSVFile, CSVFile._Fields>, java.io.Serializable, Cloneable, Comparable<CSVFile> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSVFile");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new CSVFileStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new CSVFileTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSVFile.class, metaDataMap);
  }

  public CSVFile() {
    this._id = "6c1ca5c9-4a67-4933-8471-74626ddc5257";
  ...
  public CSVFile set_id(String _id) {
    this._id = _id;
    return this;
  }
  ...
  public CSVFile setLines(java.util.List<String> lines) {
    this.lines = lines;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSVFile)
      return this.equals((CSVFile)that);
    return false;
  }

  public boolean equals(CSVFile that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(CSVFile other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSVFile(");
    boolean first = true;
  ...
  private static class CSVFileStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CSVFileStandardScheme getScheme() {
      return new CSVFileStandardScheme();
    }
  }

  private static class CSVFileStandardScheme extends org.apache.thrift.scheme.StandardScheme<CSVFile> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSVFile struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSVFile struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSVFileTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public CSVFileTupleScheme getScheme() {
      return new CSVFileTupleScheme();
    }
  }

  private static class CSVFileTupleScheme extends org.apache.thrift.scheme.TupleScheme<CSVFile> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSVFile struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSVFile struct) throws org.apache.thrift.TException {
