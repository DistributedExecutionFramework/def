...
public class LibraryAdminService {
  ...
  public interface Iface extends at.enfilo.def.library.api.thrift.LibraryService.Iface {
     ...
     * @param data
     */
    public java.lang.String uploadRoutineBinary(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends at.enfilo.def.library.api.thrift.LibraryService .AsyncIface {
    ...
    public void uploadRoutineBinary(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends at.enfilo.def.library.api.thrift.LibraryService.Client implements Iface {
    ...
    public java.lang.String uploadRoutineBinary(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data) throws org.apache.thrift.TException
    {
      send_uploadRoutineBinary(rId, md5, sizeInBytes, isPrimary, data);
      return recv_uploadRoutineBinary();
    }

    public void send_uploadRoutineBinary(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends at.enfilo.def.library.api.thrift.LibraryService.AsyncClient implements AsyncIface {
    ...
    public void uploadRoutineBinary(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      uploadRoutineBinary_call method_call = new uploadRoutineBinary_call(rId, md5, sizeInBytes, isPrimary, data, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class uploadRoutineBinary_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      ...
      public uploadRoutineBinary_call(java.lang.String rId, java.lang.String md5, long sizeInBytes, boolean isPrimary, java.nio.ByteBuffer data, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.rId = rId;
        this.md5 = md5;
  ...
  public static class Processor<I extends Iface> extends at.enfilo.def.library.api.thrift.LibraryService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class uploadRoutineBinary<I extends Iface> extends org.apache.thrift.ProcessFunction<I, uploadRoutineBinary_args> {
      ...
      public uploadRoutineBinary_result getResult(I iface, uploadRoutineBinary_args args) throws org.apache.thrift.TException {
        uploadRoutineBinary_result result = new uploadRoutineBinary_result();
        result.success = iface.uploadRoutineBinary(args.rId, args.md5, args.sizeInBytes, args.isPrimary, args.data);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends at.enfilo.def.library.api.thrift.LibraryService.AsyncProcessor<I> {
    ...
    public static class uploadRoutineBinary<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, uploadRoutineBinary_args, java.lang.String> {
      ...
      public void start(I iface, uploadRoutineBinary_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.uploadRoutineBinary(args.rId, args.md5, args.sizeInBytes, args.isPrimary, args.data,resultHandler);
      }
    }
  ...
  public static class uploadRoutineBinary_args implements org.apache.thrift.TBase<uploadRoutineBinary_args, uploadRoutineBinary_args._Fields>, java.io.Serializable, Cloneable, Comparable<uploadRoutineBinary_args>   {
    ...
    private static final org.apache.thrift.protocol.TField IS_PRIMARY_FIELD_DESC = new org.apache.thrift.protocol.TField("isPrimary", org.apache.thrift.protocol.TType.BOOL, (short)4);
    ...
    public uploadRoutineBinary_args setRId(java.lang.String rId) {
      this.rId = rId;
      return this;
    }
    ...
    public uploadRoutineBinary_args setMd5(java.lang.String md5) {
      this.md5 = md5;
      return this;
    }
    ...
    public uploadRoutineBinary_args setSizeInBytes(long sizeInBytes) {
      this.sizeInBytes = sizeInBytes;
      setSizeInBytesIsSet(true);
      return this;
    }
    ...
    public uploadRoutineBinary_args setIsPrimary(boolean isPrimary) {
      this.isPrimary = isPrimary;
      setIsPrimaryIsSet(true);
      return this;
    }
    ...
    public uploadRoutineBinary_args setData(byte[] data) {
      this.data = data == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(data.clone());
      return this;
    }

    public uploadRoutineBinary_args setData(java.nio.ByteBuffer data) {
      this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
      return this;
    }
