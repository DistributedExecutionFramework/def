...
public class NodeInfoDTO implements org.apache.thrift.TBase<NodeInfoDTO, NodeInfoDTO._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfoDTO> {
  ...
  private NodeType type; // required
  private int numberOfCores; // required
  private double load; // required
  private long timeStamp; // required
  private java.util.Map<java.lang.String,java.lang.String> parameters; // required
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NodeInfoDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter104 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter105 : struct.parameters.entrySet())
          {
