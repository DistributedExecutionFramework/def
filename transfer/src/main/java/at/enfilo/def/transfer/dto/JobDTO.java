...
public class JobDTO implements org.apache.thrift.TBase<JobDTO, JobDTO._Fields>, java.io.Serializable, Cloneable, Comparable<JobDTO> {
  ...
  private static final org.apache.thrift.protocol.TField MESSAGES_FIELD_DESC = new org.apache.thrift.protocol.TField("messages", org.apache.thrift.protocol.TType.LIST, (short)14);
  ...
  public java.lang.String programId; // required
  /**
   * 
   * @see ExecutionState
   */
  ...
  public int scheduledTasks; // required
  public int runningTasks; // required
  public int successfulTasks; // required
  public int failedTasks; // required
  public java.lang.String mapRoutineId; // required
  public java.lang.String reduceRoutineId; // optional
  public java.util.List<ResourceDTO> reducedResults; // optional
  ...
  public JobDTO setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public JobDTO setProgramId(java.lang.String programId) {
    this.programId = programId;
    return this;
  }
   ...
   * @see ExecutionState
   */
  public JobDTO setState(ExecutionState state) {
    this.state = state;
    return this;
  }
  ...
  public JobDTO setCreateTime(long createTime) {
    this.createTime = createTime;
    setCreateTimeIsSet(true);
    return this;
  }
  ...
  public JobDTO setStartTime(long startTime) {
    this.startTime = startTime;
    setStartTimeIsSet(true);
    return this;
  }
  ...
  public JobDTO setFinishTime(long finishTime) {
    this.finishTime = finishTime;
    setFinishTimeIsSet(true);
    return this;
  }
  ...
  public JobDTO setScheduledTasks(int scheduledTasks) {
    this.scheduledTasks = scheduledTasks;
    setScheduledTasksIsSet(true);
    return this;
  }
  ...
  public JobDTO setRunningTasks(int runningTasks) {
    this.runningTasks = runningTasks;
    setRunningTasksIsSet(true);
    return this;
  }
  ...
  public JobDTO setSuccessfulTasks(int successfulTasks) {
    this.successfulTasks = successfulTasks;
    setSuccessfulTasksIsSet(true);
    return this;
  }
  ...
  public JobDTO setFailedTasks(int failedTasks) {
    this.failedTasks = failedTasks;
    setFailedTasksIsSet(true);
    return this;
  }
  ...
  public JobDTO setMapRoutineId(java.lang.String mapRoutineId) {
    this.mapRoutineId = mapRoutineId;
    return this;
  }
  ...
  public JobDTO setReduceRoutineId(java.lang.String reduceRoutineId) {
  ...
  public JobDTO setReducedResults(java.util.List<ResourceDTO> reducedResults) {
  ...
  public JobDTO setMessages(java.util.List<java.lang.String> messages) {
    this.messages = messages;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messages = new java.util.ArrayList<java.lang.String>(_list37.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.reducedResults != null) {
        if (struct.isSetReducedResults()) {
          oprot.writeFieldBegin(REDUCED_RESULTS_FIELD_DESC);
          {
            ...
            for (ResourceDTO _iter40 : struct.reducedResults)
            {
              _iter40.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.messages != null) {
        oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter41 : struct.messages)
          {
      ...
      if (struct.isSetReducedResults()) {
        {
          ...
          for (ResourceDTO _iter42 : struct.reducedResults)
          {
            _iter42.write(oprot);
          }
        }
      ...
      if (struct.isSetMessages()) {
        {
          ...
          for (java.lang.String _iter43 : struct.messages)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.reducedResults = new java.util.ArrayList<ResourceDTO>(_list44.size);
          ResourceDTO _elem45;
          for (int _i46 = 0; _i46 < _list44.size; ++_i46)
          {
            _elem45 = new ResourceDTO();
            _elem45.read(iprot);
            struct.reducedResults.add(_elem45);
          }
        }
        struct.setReducedResultsIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.messages = new java.util.ArrayList<java.lang.String>(_list47.size);
