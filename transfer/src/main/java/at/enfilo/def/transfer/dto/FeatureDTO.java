...
public class FeatureDTO implements org.apache.thrift.TBase<FeatureDTO, FeatureDTO._Fields>, java.io.Serializable, Cloneable, Comparable<FeatureDTO> {
  ...
  public java.lang.String baseId; // required
  public java.lang.String name; // required
  public java.lang.String group; // required
  public java.lang.String version; // required
  public java.util.List<FeatureDTO> extensions; // required
  ...
  public FeatureDTO setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public FeatureDTO setBaseId(java.lang.String baseId) {
    this.baseId = baseId;
    return this;
  }
  ...
  public FeatureDTO setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public FeatureDTO setGroup(java.lang.String group) {
    this.group = group;
    return this;
  }
  ...
  public FeatureDTO setVersion(java.lang.String version) {
    this.version = version;
    return this;
  }
  ...
  public FeatureDTO setExtensions(java.util.List<FeatureDTO> extensions) {
    this.extensions = extensions;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.extensions = new java.util.ArrayList<FeatureDTO>(_list136.size);
                FeatureDTO _elem137;
                for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                {
                  _elem137 = new FeatureDTO();
                  _elem137.read(iprot);
                  struct.extensions.add(_elem137);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FeatureDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.extensions != null) {
        oprot.writeFieldBegin(EXTENSIONS_FIELD_DESC);
        {
          ...
          for (FeatureDTO _iter139 : struct.extensions)
          {
      ...
      if (struct.isSetExtensions()) {
        {
          ...
          for (FeatureDTO _iter140 : struct.extensions)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.extensions = new java.util.ArrayList<FeatureDTO>(_list141.size);
          FeatureDTO _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = new FeatureDTO();
            _elem142.read(iprot);
            struct.extensions.add(_elem142);
          }
        }
        struct.setExtensionsIsSet(true);
      }
