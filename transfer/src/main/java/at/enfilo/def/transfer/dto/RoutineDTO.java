...
public class RoutineDTO implements org.apache.thrift.TBase<RoutineDTO, RoutineDTO._Fields>, java.io.Serializable, Cloneable, Comparable<RoutineDTO> {
  ...
  private boolean privateRoutine; // required
  private java.lang.String name; // required
  private java.lang.String description; // required
  private short revision; // required
  private RoutineType type; // required
  private java.util.List<FormalParameterDTO> inParameters; // required
  private FormalParameterDTO outParameter; // required
  private java.util.Set<RoutineBinaryDTO> routineBinaries; // required
  private java.util.List<java.lang.String> arguments; // required
  private java.util.List<FeatureDTO> requiredFeatures; // required
  ...
  public void setInParameters(java.util.List<FormalParameterDTO> inParameters) {
    this.inParameters = inParameters;
  }
  ...
  public void setOutParameter(FormalParameterDTO outParameter) {
    this.outParameter = outParameter;
  }
  ...
  public void setRoutineBinaries(java.util.Set<RoutineBinaryDTO> routineBinaries) {
    this.routineBinaries = routineBinaries;
  }
  ...
  public void setRequiredFeatures(java.util.List<FeatureDTO> requiredFeatures) {
    this.requiredFeatures = requiredFeatures;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.inParameters = new java.util.ArrayList<FormalParameterDTO>(_list42.size);
                FormalParameterDTO _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new FormalParameterDTO();
                  _elem43.read(iprot);
                  struct.inParameters.add(_elem43);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.routineBinaries = new java.util.HashSet<RoutineBinaryDTO>(2*_set45.size);
                RoutineBinaryDTO _elem46;
                for (int _i47 = 0; _i47 < _set45.size; ++_i47)
                {
                  _elem46 = new RoutineBinaryDTO();
                  _elem46.read(iprot);
                  struct.routineBinaries.add(_elem46);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.requiredFeatures = new java.util.ArrayList<FeatureDTO>(_list51.size);
                FeatureDTO _elem52;
                for (int _i53 = 0; _i53 < _list51.size; ++_i53)
                {
                  _elem52 = new FeatureDTO();
                  _elem52.read(iprot);
                  struct.requiredFeatures.add(_elem52);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RoutineDTO struct) throws org.apache.thrift.TException {
      ...
      if (struct.inParameters != null) {
        oprot.writeFieldBegin(IN_PARAMETERS_FIELD_DESC);
        {
          ...
          for (FormalParameterDTO _iter54 : struct.inParameters)
          {
            _iter54.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.routineBinaries != null) {
        oprot.writeFieldBegin(ROUTINE_BINARIES_FIELD_DESC);
        {
          ...
          for (RoutineBinaryDTO _iter55 : struct.routineBinaries)
          {
            _iter55.write(oprot);
          }
          oprot.writeSetEnd();
      ...
      if (struct.requiredFeatures != null) {
        oprot.writeFieldBegin(REQUIRED_FEATURES_FIELD_DESC);
        {
          ...
          for (FeatureDTO _iter57 : struct.requiredFeatures)
          {
            _iter57.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetInParameters()) {
        {
          ...
          for (FormalParameterDTO _iter58 : struct.inParameters)
          {
            _iter58.write(oprot);
          }
        }
      ...
      if (struct.isSetRoutineBinaries()) {
        {
          ...
          for (RoutineBinaryDTO _iter59 : struct.routineBinaries)
          {
            _iter59.write(oprot);
          }
        }
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (java.lang.String _iter60 : struct.arguments)
          {
      ...
      if (struct.isSetRequiredFeatures()) {
        {
          ...
          for (FeatureDTO _iter61 : struct.requiredFeatures)
          {
            _iter61.write(oprot);
          }
        }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.inParameters = new java.util.ArrayList<FormalParameterDTO>(_list62.size);
          FormalParameterDTO _elem63;
          for (int _i64 = 0; _i64 < _list62.size; ++_i64)
          {
            _elem63 = new FormalParameterDTO();
            _elem63.read(iprot);
            struct.inParameters.add(_elem63);
          }
        }
        struct.setInParametersIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.routineBinaries = new java.util.HashSet<RoutineBinaryDTO>(2*_set65.size);
          RoutineBinaryDTO _elem66;
          for (int _i67 = 0; _i67 < _set65.size; ++_i67)
          {
            _elem66 = new RoutineBinaryDTO();
            _elem66.read(iprot);
            struct.routineBinaries.add(_elem66);
          }
        }
        struct.setRoutineBinariesIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<java.lang.String>(_list68.size);
          java.lang.String _elem69;
          for (int _i70 = 0; _i70 < _list68.size; ++_i70)
          {
            _elem69 = iprot.readString();
            struct.arguments.add(_elem69);
          }
        }
        struct.setArgumentsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.requiredFeatures = new java.util.ArrayList<FeatureDTO>(_list71.size);
          FeatureDTO _elem72;
          for (int _i73 = 0; _i73 < _list71.size; ++_i73)
          {
            _elem72 = new FeatureDTO();
            _elem72.read(iprot);
            struct.requiredFeatures.add(_elem72);
          }
        }
        struct.setRequiredFeaturesIsSet(true);
      }
