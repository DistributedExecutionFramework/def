...
public class Order implements org.apache.thrift.TBase<Order, Order._Fields>, java.io.Serializable, Cloneable, Comparable<Order> {
   ...
   * @see Command
   */
  public Order setCommand(Command command) {
    this.command = command;
    return this;
  }
  ...
  public Order setValue(java.lang.String value) {
    this.value = value;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // COMMAND
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.command = at.enfilo.def.routine.api.Command.findByValue(iprot.readI32());
