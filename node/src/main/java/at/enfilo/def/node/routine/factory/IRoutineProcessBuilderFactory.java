...
public interface IRoutineProcessBuilderFactory {
    ...
    ProcessBuilder getRoutineProcessBuilder(RoutineDTO routineDTO, SequenceStep sequenceStep, NodeConfiguration configuration, boolean addOutPipe) throws RoutineCreationException;
}
