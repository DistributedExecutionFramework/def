...
public class PlaceholderTest {
    ...
    public void argumentsTest() {
        ...
        assertNull(aPlaceholder2.get("args"));
        assertNull(aPlaceholder3.get("args"));
    }
    ...
    public void pipeTest() {
        ...
        assertNull(pPlaceholder.get("in"));
        assertEquals("ctrl", pPlaceholder.get("ctrl"));
        assertNull(pPlaceholder.get("out"));
        ...
        assertNull(pPlaceholder2.get("out"));
        ...
        assertNull(pPlaceholder3.get("out"));
    ...
    public void binaryTest() throws Exception {
        ...
        assertNull(bPlaceholder.get("rbp"));
        List<String> bResult = binaries.stream().map(RoutineBinaryDTO::getExecutionUrl).collect(Collectors.toList());
        ...
        List<String> bResult2 = binaries2.stream().filter(binary -> !binary.isPrimary()).map(RoutineBinaryDTO::getExecutionUrl).collect(Collectors.toList());
        assertEquals(binary2.getExecutionUrl(), bPlaceholder2.get("rbp"));
