...
public class DEFIntegerMatrix implements org.apache.thrift.TBase<DEFIntegerMatrix, DEFIntegerMatrix._Fields>, java.io.Serializable, Cloneable, Comparable<DEFIntegerMatrix> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DEFIntegerMatrix");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DEFIntegerMatrixStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DEFIntegerMatrixTupleSchemeFactory();

  public java.lang.String _id; // optional
  public java.util.List<java.lang.Integer> values; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DEFIntegerMatrix.class, metaDataMap);
  }

  public DEFIntegerMatrix() {
    this._id = "7f9a791a-da86-36eb-9cfe-65c791975950";
   ...
   */
  public DEFIntegerMatrix(DEFIntegerMatrix other) {
  ...
  public DEFIntegerMatrix deepCopy() {
    return new DEFIntegerMatrix(this);
  }
  ...
  public DEFIntegerMatrix set_id(java.lang.String _id) {
    this._id = _id;
    return this;
  }
  ...
  public DEFIntegerMatrix setValues(java.util.List<java.lang.Integer> values) {
    this.values = values;
    return this;
  }
  ...
  public DEFIntegerMatrix setCols(int cols) {
    this.cols = cols;
    setColsIsSet(true);
    return this;
  }
  ...
  public DEFIntegerMatrix setRows(int rows) {
    this.rows = rows;
    setRowsIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DEFIntegerMatrix)
      return this.equals((DEFIntegerMatrix)that);
    return false;
  }

  public boolean equals(DEFIntegerMatrix that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DEFIntegerMatrix other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DEFIntegerMatrix(");
    boolean first = true;
  ...
  private static class DEFIntegerMatrixStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DEFIntegerMatrixStandardScheme getScheme() {
      return new DEFIntegerMatrixStandardScheme();
    }
  }

  private static class DEFIntegerMatrixStandardScheme extends org.apache.thrift.scheme.StandardScheme<DEFIntegerMatrix> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DEFIntegerMatrix struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new java.util.ArrayList<java.lang.Integer>(_list0.size);
                int _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DEFIntegerMatrix struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DEFIntegerMatrixTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DEFIntegerMatrixTupleScheme getScheme() {
      return new DEFIntegerMatrixTupleScheme();
    }
  }

  private static class DEFIntegerMatrixTupleScheme extends org.apache.thrift.scheme.TupleScheme<DEFIntegerMatrix> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DEFIntegerMatrix struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DEFIntegerMatrix struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.values = new java.util.ArrayList<java.lang.Integer>(_list5.size);
          int _elem6;
