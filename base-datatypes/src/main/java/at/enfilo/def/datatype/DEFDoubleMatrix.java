...
public class DEFDoubleMatrix implements org.apache.thrift.TBase<DEFDoubleMatrix, DEFDoubleMatrix._Fields>, java.io.Serializable, Cloneable, Comparable<DEFDoubleMatrix> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DEFDoubleMatrix");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DEFDoubleMatrixStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DEFDoubleMatrixTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DEFDoubleMatrix.class, metaDataMap);
  }

  public DEFDoubleMatrix() {
    this._id = "94ece2b5-df0a-32b7-bab8-9d4b9e95df89";
   ...
   */
  public DEFDoubleMatrix(DEFDoubleMatrix other) {
  ...
  public DEFDoubleMatrix deepCopy() {
    return new DEFDoubleMatrix(this);
  }
  ...
  public DEFDoubleMatrix set_id(java.lang.String _id) {
    this._id = _id;
    return this;
  }
  ...
  public DEFDoubleMatrix setValues(java.util.List<java.lang.Double> values) {
    this.values = values;
    return this;
  }
  ...
  public DEFDoubleMatrix setCols(int cols) {
    this.cols = cols;
    setColsIsSet(true);
    return this;
  }
  ...
  public DEFDoubleMatrix setRows(int rows) {
    this.rows = rows;
    setRowsIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DEFDoubleMatrix)
      return this.equals((DEFDoubleMatrix)that);
    return false;
  }

  public boolean equals(DEFDoubleMatrix that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DEFDoubleMatrix other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DEFDoubleMatrix(");
    boolean first = true;
  ...
  private static class DEFDoubleMatrixStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DEFDoubleMatrixStandardScheme getScheme() {
      return new DEFDoubleMatrixStandardScheme();
    }
  }

  private static class DEFDoubleMatrixStandardScheme extends org.apache.thrift.scheme.StandardScheme<DEFDoubleMatrix> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DEFDoubleMatrix struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DEFDoubleMatrix struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DEFDoubleMatrixTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DEFDoubleMatrixTupleScheme getScheme() {
      return new DEFDoubleMatrixTupleScheme();
    }
  }

  private static class DEFDoubleMatrixTupleScheme extends org.apache.thrift.scheme.TupleScheme<DEFDoubleMatrix> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DEFDoubleMatrix struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DEFDoubleMatrix struct) throws org.apache.thrift.TException {
