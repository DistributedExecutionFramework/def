...
public class LibraryAdminServiceThriftHTTPTest extends LibraryAdminServiceTest {
    ...
    protected IServer getServer() throws ServerCreationException {
        ...
        return ThriftHTTPServer.getInstance(
            Library.getInstance().getConfiguration().getServerHolderConfiguration().getThriftHTTPConfiguration(),
            thriftProcessors
        );
    }
}
